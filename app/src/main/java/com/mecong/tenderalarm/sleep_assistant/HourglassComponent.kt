...
class HourglassComponent(context: Context, attrs: AttributeSet?) : View(context, attrs) {
    ...
    override fun onDraw(canvas: Canvas) {
        super.onDraw(canvas)
        val filled = frame!!.height() - frameHeightDivMax * currentValue
        //        canvas.drawRoundRect(frame.left, filled, frame.right, frame.bottom,25f,25f, filledPaint);
        canvas.drawRect(frame!!.left + 10.toFloat(), filled, frame!!.right - 10.toFloat(), frame!!.bottom.toFloat(), filledPaint)
