...
internal constructor(
  ...
  override fun onBindViewHolder(viewHolder: MediaItemViewHolder, position: Int) {
    ...
    viewHolder.headerText.text =
      if (Strings.isEmptyOrWhitespace(myListItem.header)) myListItem.uri else myListItem.header
  ...
  inner class MediaItemViewHolder internal constructor(itemView: View) : RecyclerView.ViewHolder(itemView),
