...
class AdditionalActivity : AppCompatActivity() {
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    val appLinkButton = findViewById<Button>(R.id.appLinkButton)
    val appShareButton = findViewById<Button>(R.id.appShareButton)
    val autostartOpenButton = findViewById<Button>(R.id.autostartOpenButton)
    val autostartPrompt = findViewById<TextView>(R.id.autostartPrompt)
