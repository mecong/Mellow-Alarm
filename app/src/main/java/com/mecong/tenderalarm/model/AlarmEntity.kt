...
data class AlarmEntity(
  var id: Long = -1, var hour: Int = 0, var minute: Int = 0, var days: Int = 0,
  ...
  constructor(cursor: Cursor) : this(
    ...
    days = cursor.getInt(cursor.getColumnIndexOrThrow("days")),
    complexity = cursor.getInt(cursor.getColumnIndexOrThrow("complexity")),
    exactDate = cursor.getLong(cursor.getColumnIndexOrThrow("exact_date")),
    message = cursor.getString(cursor.getColumnIndexOrThrow("message")),
    isActive = cursor.getInt(cursor.getColumnIndexOrThrow("active")) == 1,
    ticksTime = cursor.getInt(cursor.getColumnIndexOrThrow("ticks_time")),
    ticksType = cursor.getInt(cursor.getColumnIndexOrThrow("ticks_type")),
    melodyUrl = cursor.getString(cursor.getColumnIndexOrThrow("melody_url")),
    melodyName = cursor.getString(cursor.getColumnIndexOrThrow("melody_name")),
    vibrationType = cursor.getString(cursor.getColumnIndexOrThrow("vibration_type")),
    volume = cursor.getInt(cursor.getColumnIndexOrThrow("volume")),
    snoozeMaxTimes = cursor.getInt(cursor.getColumnIndexOrThrow("snooze_max_times")),
    canceledNextAlarms = cursor.getInt(cursor.getColumnIndexOrThrow("canceled_next_alarms")),
    nextTime = cursor.getLong(cursor.getColumnIndexOrThrow("next_time")),
    nextNotCanceledTime = cursor.getLong(cursor.getColumnIndexOrThrow("next_not_canceled_time")),
    nextRequestCode = cursor.getInt(cursor.getColumnIndexOrThrow("next_request_code")),
    isHeadsUp = cursor.getInt(cursor.getColumnIndexOrThrow("heads_up")) == 1,
    isTimeToSleepNotification = cursor.getInt(cursor.getColumnIndexOrThrow("tts_notification")) == 1,
    increaseVolume = cursor.getInt(cursor.getColumnIndexOrThrow("increase_volume"))
  )
